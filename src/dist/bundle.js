...
ReactDOM.render(React.createElement(
    ...
    React.createElement(
        Route,
        { path: '/template', component: RieslingTemplateAPP },
        React.createElement(IndexRoute, { component: indexPage }),
        React.createElement(Route, { path: 'create', component: CreateRepositoryPage })
    )
), document.getElementById("appRoot"));


},{"./components/app.react":218,"./components/create-repository-page/create-repository-page.react":219,"./components/indexpage/indexpage.react":223,"react":215,"react-dom":2,"react-router":30}],218:[function(require,module,exports){
'use strict';
...
var RieslingTemplateAPP = React.createClass({
    displayName: 'RieslingTemplateAPP',
...
},{"./footer/footer.react":220,"./header/header.react":221,"react":215}],219:[function(require,module,exports){
'use strict';

/**
 * Created by ssge on 2016/3/31.
 */
var React = require('react');

var CreateRepositoryPage = React.createClass({
    displayName: 'CreateRepositoryPage',
...
var HeaderSection = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                "div",
                { className: "ui grid padded container" },
                React.createElement(
                    "div",
                    { className: "column" },
                    React.createElement(
                        ...
                        React.createElement(
                            "div",
                            { className: "column" },
                            React.createElement("img", { src: "image/template-app.png", width: "30px" })
                        ),
                        React.createElement(
                            "div",
                            { className: "column" },
                ...
                React.createElement(
                    "div",
                    { className: "thirteen wide column center aligned" },
                    "Placeholder"
                ),
                React.createElement(
                    "div",
                    ...
                    React.createElement(
                        "div",
                        { id: "account-image" },
                        React.createElement("img", { src: "image/people.png", width: "25px" })
                    )
                )
            )
        );
...
var CreateButton = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                Link,
                { to: this.props.buttonProps.path },
                React.createElement(
                    'button',
                    { className: className },
                    this.props.buttonProps.name
                )
            )
        );
    }
...
},{"react":215,"react-router":30}],223:[function(require,module,exports){
'use strict';
...
var IndexPage = React.createClass({
    ...
    render: function render() {
        var generateButtonsView = function generateButtonsView(eachButton, index) {
            return React.createElement(CreateButton, { buttonProps: eachButton, key: index });
        };
        ...
        return React.createElement(
            'div',
            { className: 'light-grey-background index-page-wrapper' },
            React.createElement(
                'div',
                { id: 'text-chooseone-wrapper' },
                'Choose One To Create...'
            ),
            React.createElement(
                'div',
                { id: 'button-choose-wrapper', className: 'ui stackable centered three column grid container' },
                buttonsView
            )
        );
    }
...
},{"./createbutton.react":222,"react":215,"underscore":216}]},{},[217]);
